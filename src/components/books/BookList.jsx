    ...
    return (
        <>
            <div className='p-3 flex justify-between items-center'>
                ...
                <button className='bg-[#5058b2] text-white py-2 px-3 shadow-md rounded-md flex gap-2 items-center'><BsPlusLg size={20} />New Book</button>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md">
                <div className='grid grid-cols-6 p-5'>
                    ...
                    <div>
                        <h5 className="font-semibold flex items-center gap-1">Name <span><BiSort className='text-gray-500' /></span></h5>
                    </div>
                    ...
                    <div>
                        <h5 className="font-semibold">Publication</h5>
                    </div>
